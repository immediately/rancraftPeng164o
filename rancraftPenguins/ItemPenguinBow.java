...
public class ItemPenguinBow extends ItemBow {
    ...
    public static final String[] field_94601_a = new String[] {RanCraftPenguins.modID + ":pengBow_1", RanCraftPenguins.modID + ":pengBow_2", RanCraftPenguins.modID + ":pengBow_3", RanCraftPenguins.modID + ":pengBow_4"};
    
    //@SideOnly(Side.CLIENT)
    private Icon[] IconAni = new Icon[4];

    public ItemPenguinBow(int par1) {
		super(par1);
    ...
    {
        this.IconAni = new Icon[field_94601_a.length];
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
	{
	    ...
	    if(var6 > penguinBowTransitions[3]){
     		var6 = penguinBowTransitions[3];
    	}
        if(var6 > penguinBowTransitions[2]){ /* only amplify it if it's already at the final image */
        	var6 *= 2;
        }
    ...
    public void onUpdate(ItemStack par1ItemStack, World world, Entity entity, int par4, boolean flag)
	{
        ...
        if(entityplayer.isUsingItem() && itemstack1.itemID == RanCraftPenguins.PenguinBow.itemID)
        {
