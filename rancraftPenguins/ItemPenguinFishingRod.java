...
{
	static int rodIcon = 0;
	private int counter = 5;
	
    @SideOnly(Side.CLIENT)
    private Icon theIcon;
    private Icon[] IconAni = new Icon[2];

    public ItemPenguinFishingRod(int par1)
    {
        super(par1);
        this.setMaxDamage(96); // 1.5x the durability of ItemFishingRod
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        else
        {
            ...
            if (!par2World.isRemote)
            {
    			//System.out.printf("Trying to spawn a hook!\n");
            	...
            	//this.itemIcon = IconAni[1]; // icon 1 is in the cast state
            }
