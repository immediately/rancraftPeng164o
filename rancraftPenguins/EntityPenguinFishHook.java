...
public class EntityPenguinFishHook extends EntityFishHook
{
    ...
    private short oneInThisChanceOfCatching;
    ...
    @SideOnly(Side.CLIENT)
    public EntityPenguinFishHook(World par1World, double par2, double par4, double par6, EntityPlayer par8EntityPlayer)
    {
        this(par1World);
    ...
    public EntityPenguinFishHook(World par1World, EntityPlayer par2EntityPlayer)
    {
        ...
        this.oneInThisChanceOfCatching = 130; // 500 for vanilla fishing rod 
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
        this.inTile = 0;
...
*/
    ...
    public void onUpdate()
    {
        ...
        else
        {
            if (!this.worldObj.isRemote)
            {
                ...
                if (this.angler.isDead || !this.angler.isEntityAlive() || itemstack == null || itemstack.getItem() != RanCraftPenguins.PenguinFishingRod || this.getDistanceSqToEntity(this.angler) > 1024.0D)
                {
                    Item possibleFishingRod = (itemstack != null)?itemstack.getItem():null;
                    if(possibleFishingRod != null && possibleFishingRod.itemID == RanCraftPenguins.PenguinFishingRod.itemID){
            ...
            if (!this.inGround)
            {
                ...
                if (d6 > 0.0D)
                {
                    ...
                    {
                        short short1 = oneInThisChanceOfCatching;
    ...
    public int catchFish()
    {
        ...
        else
        {
            ...
            {
                catchCount = rand.nextInt(3); // 1 - 3 fish
